    ...
    <div className="w-full flex flex-col py-8 px-16 pb-64 mx-auto md:max-w-[1024px] md:flex-row md:gap-16 md:items-start md:justify-start">
      <div className="w-full md:w-3/5">
        ...
        <Text className="text-lg pb-4">
          <strong>{orgName}</strong> has invited you to join us at Cyclical for
          mentorship and work therapy sessions. We&rsquo;re here to help you
          create a healthy work-life balance, achieve your professional goals,
          and get the absolute most out of your role at {orgName}.
        </Text>
        <Text className="text-lg pb-4">
        ...
        <Text className="text-lg pb-4">
          ...
          primary focus here is workplace wellness and professional development,
          our mentors are also available to help you with personal struggles
          should you choose to share them.
        </Text>
        <Text className="text-lg pb-4">
          <strong>You are under no obligation to participate.</strong> Though we
          encourage you to try a few sessions, you&rsquo;re not—and never will
          be—required to engage in our sessions.
        </Text>
        <Text className="text-lg pb-4">
          <strong>
            {orgName} is covering 100% of the cost of your sessions.
          </strong>{" "}
          {orgName} is offering this benefit to you because it&rsquo;s committed
          to providing workplace wellness and the support you need to reach your
          professional goals. They even{" "}
